...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Laravel')); ?> | Posts</title>
    ...
    <body>
        ...
        <div class="layout">
            <aside class="panel">
                ...
                <ul class="category-list">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a
                                class="category-link <?php echo e($activeSlug === $category->slug ? 'is-active' : ''); ?>"
            ...
            <section class="panel">
                <h2 class="title"><?php echo e($activeCategory?->name ?? 'All Posts'); ?></h2>
...
<?php /**PATH C:\Users\Maris\OneDrive\Desktop\IT15_BACKEND\resources\views/welcome.blade.php ENDPATH**/ ?>